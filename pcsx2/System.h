...
namespace HostMemoryMap
{
	...
	static const u32 IOPmemOffset  = 0x04000000 + _128mbOffset;

	// VU0 and VU1 memory.
	static const u32 VUmemOffset   = 0x08000000 + _128mbOffset;

	// EE recompiler code cache area (64mb)
	static const u32 EErecOffset   = 0x10000000 + _128mbOffset;

	// IOP recompiler code cache area (16 or 32mb)
	static const u32 IOPrecOffset  = 0x14000000 + _128mbOffset;

	// newVif0 recompiler code cache area (16mb)
	static const u32 VIF0recOffset = 0x16000000 + _128mbOffset;

	// newVif1 recompiler code cache area (32mb)
	static const u32 VIF1recOffset = 0x18000000 + _128mbOffset;

	// microVU1 recompiler code cache area (32 or 64mb)
	static const u32 mVU0recOffset = 0x1C000000 + _128mbOffset;

	// microVU0 recompiler code cache area (64mb)
	static const u32 mVU1recOffset = 0x20000000 + _128mbOffset;
	...
	static const u32 bumpAllocatorOffset = 0x24000000 + _128mbOffset;
}
